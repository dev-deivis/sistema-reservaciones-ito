...
INSERT INTO historial_cambios (reservacion_id, usuario_id, accion, detalle) VALUES
  ((SELECT id FROM reservaciones WHERE motivo='Clase de Álgebra Lineal'),                      (SELECT id FROM usuarios WHERE email='carlos@ito.mx' LIMIT 1),   'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Práctica de programación en Python'),           (SELECT id FROM usuarios WHERE email='ana@ito.mx' LIMIT 1),      'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Práctica de configuración de routers'),         (SELECT id FROM usuarios WHERE email='luis@ito.mx' LIMIT 1),     'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Reunión de academia de Sistemas'),              (SELECT id FROM usuarios WHERE email='rosa@ito.mx' LIMIT 1),     'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Exposición de proyecto integrador'),            (SELECT id FROM usuarios WHERE email='fernando@ito.mx' LIMIT 1), 'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Exposición de proyecto integrador'),            (SELECT id FROM usuarios WHERE email='fernando@ito.mx' LIMIT 1), 'cancelacion',  'Reservación cancelada por el usuario'),
  ((SELECT id FROM reservaciones WHERE motivo='Práctica de circuitos analógicos'),             (SELECT id FROM usuarios WHERE email='gabriela@ito.mx' LIMIT 1),'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Examen de Cálculo Diferencial'),                (SELECT id FROM usuarios WHERE email='miguel@ito.mx' LIMIT 1),   'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Presentación de proyectos de titulación'),      (SELECT id FROM usuarios WHERE email='sofia@ito.mx' LIMIT 1),    'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Taller de desarrollo web con React'),           (SELECT id FROM usuarios WHERE email='andres@ito.mx' LIMIT 1),   'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Taller de desarrollo web con React'),           (SELECT id FROM usuarios WHERE email='andres@ito.mx' LIMIT 1),   'cancelacion',  'Reservación cancelada por el usuario'),
  ((SELECT id FROM reservaciones WHERE motivo='Junta de coordinadores de carrera'),            (SELECT id FROM usuarios WHERE email='patricia@ito.mx' LIMIT 1),'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Práctica de programación de robots'),           (SELECT id FROM usuarios WHERE email='hector@ito.mx' LIMIT 1),   'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Clase de Estructuras de Datos'),                (SELECT id FROM usuarios WHERE email='diana@ito.mx' LIMIT 1),    'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Práctica de soldadura SMD'),                    (SELECT id FROM usuarios WHERE email='roberto@ito.mx' LIMIT 1),  'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Torneo intercarreras de voleibol'),             (SELECT id FROM usuarios WHERE email='valeria@ito.mx' LIMIT 1),  'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Práctica de análisis de muestras'),             (SELECT id FROM usuarios WHERE email='jorge@ito.mx' LIMIT 1),    'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Práctica de análisis de muestras'),             (SELECT id FROM usuarios WHERE email='jorge@ito.mx' LIMIT 1),    'cancelacion',  'Reservación cancelada por el usuario'),
  ((SELECT id FROM reservaciones WHERE motivo='Conferencia de innovación tecnológica'),        (SELECT id FROM usuarios WHERE email='monica@ito.mx' LIMIT 1),   'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Ceremonia de bienvenida a nuevos alumnos'),     (SELECT id FROM usuarios WHERE email='eduardo@ito.mx' LIMIT 1),  'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Examen de Programación Orientada a Objetos'),   (SELECT id FROM usuarios WHERE email='carlos@ito.mx' LIMIT 1),   'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Reunión con empresa vinculada por videollamada'),(SELECT id FROM usuarios WHERE email='ana@ito.mx' LIMIT 1),      'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Práctica de ajuste y calibración'),             (SELECT id FROM usuarios WHERE email='luis@ito.mx' LIMIT 1),     'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Curso de metodología de investigación'),        (SELECT id FROM usuarios WHERE email='rosa@ito.mx' LIMIT 1),     'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Curso de metodología de investigación'),        (SELECT id FROM usuarios WHERE email='rosa@ito.mx' LIMIT 1),     'cancelacion',  'Reservación cancelada por el usuario'),
  ((SELECT id FROM reservaciones WHERE motivo='Práctica de protocolo TCP/IP'),                 (SELECT id FROM usuarios WHERE email='fernando@ito.mx' LIMIT 1), 'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Reunión de seguimiento de residencias profesionales'),(SELECT id FROM usuarios WHERE email='gabriela@ito.mx' LIMIT 1),'creacion','Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Noche cultural del ITO'),                       (SELECT id FROM usuarios WHERE email='miguel@ito.mx' LIMIT 1),   'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Clase de Bases de Datos Avanzadas'),            (SELECT id FROM usuarios WHERE email='sofia@ito.mx' LIMIT 1),    'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Práctica de manufactura CNC'),                  (SELECT id FROM usuarios WHERE email='andres@ito.mx' LIMIT 1),   'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Entrevista de seguimiento a egresados'),        (SELECT id FROM usuarios WHERE email='patricia@ito.mx' LIMIT 1), 'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Taller de seguridad informática'),              (SELECT id FROM usuarios WHERE email='hector@ito.mx' LIMIT 1),   'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Congreso estudiantil de ingeniería'),           (SELECT id FROM usuarios WHERE email='diana@ito.mx' LIMIT 1),    'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Práctica de amplificadores operacionales'),     (SELECT id FROM usuarios WHERE email='roberto@ito.mx' LIMIT 1),  'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Clase de Ingeniería de Software'),              (SELECT id FROM usuarios WHERE email='valeria@ito.mx' LIMIT 1),  'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Práctica de redes inalámbricas'),               (SELECT id FROM usuarios WHERE email='jorge@ito.mx' LIMIT 1),    'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Reunión de planeación semestral'),              (SELECT id FROM usuarios WHERE email='monica@ito.mx' LIMIT 1),   'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Práctica de visión computacional'),             (SELECT id FROM usuarios WHERE email='eduardo@ito.mx' LIMIT 1),  'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Repaso de examen de Análisis de Algoritmos'),   (SELECT id FROM usuarios WHERE email='carlos@ito.mx' LIMIT 1),   'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Taller de IoT con ESP32'),                      (SELECT id FROM usuarios WHERE email='ana@ito.mx' LIMIT 1),      'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Expo de proyectos de Ingeniería en Sistemas'),  (SELECT id FROM usuarios WHERE email='luis@ito.mx' LIMIT 1),     'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Clase de Sistemas Operativos'),                 (SELECT id FROM usuarios WHERE email='rosa@ito.mx' LIMIT 1),     'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Práctica de síntesis de polímeros'),            (SELECT id FROM usuarios WHERE email='fernando@ito.mx' LIMIT 1), 'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Defensa de residencia profesional por videollamada'),(SELECT id FROM usuarios WHERE email='gabriela@ito.mx' LIMIT 1),'creacion','Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Ceremonia de titulación generación 2026'),      (SELECT id FROM usuarios WHERE email='miguel@ito.mx' LIMIT 1),   'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Festival deportivo fin de semestre'),           (SELECT id FROM usuarios WHERE email='sofia@ito.mx' LIMIT 1),    'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Examen final de Desarrollo de Software'),       (SELECT id FROM usuarios WHERE email='andres@ito.mx' LIMIT 1),   'creacion',     'Reservación creada'),
  ((SELECT id FROM reservaciones WHERE motivo='Congreso regional de tecnología e innovación'), (SELECT id FROM usuarios WHERE email='patricia@ito.mx' LIMIT 1), 'creacion',     'Reservación creada');